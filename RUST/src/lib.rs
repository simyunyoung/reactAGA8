...
#[cfg(target_arch = "wasm32")]
impl From<Properties> for JsProperties {
...
#[cfg(target_arch = "wasm32")]
#[wasm_bindgen]
pub fn calculate_aga8(composition: &[f64], pressure: f64, temperature: f64) -> JsProperties {
    assert_eq!(composition.len(), detail::NC_DETAIL);
    let mut aga8_test: Detail = Detail::new();
    aga8_test.setup();
    aga8_test.x[0..detail::NC_DETAIL].clone_from_slice(composition);
    aga8_test.t = temperature;
    aga8_test.p = pressure;
    aga8_test.density_detail();
    aga8_test.properties_detail();
    JsProperties::from(Properties {
        d: aga8_test.d,
        mm: aga8_test.mm,
        z: aga8_test.z,
        dp_dd: aga8_test.dp_dd,
